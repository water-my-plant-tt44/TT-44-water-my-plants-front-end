...
const Plant = (props) => {
   ...
   // useEffect(() => {
   //   console.log('indiv plant');
   //   props.getPlant(plantId);
   // }, [])
               ...
               <Grid container className={classes.textContainer}>
                       <Grid item className={classes.items}>
                           <Typography variant='h4' className={classes.header}>
                               {/* Sandra The Plant */}
                               {props.plants.nickname}
                           </Typography>
                       </Grid>
                       <Grid item className={classes.items}>
                           <Typography variant='h5' className={classes.speciesStyles}>
                               {/* Maximus Pollergoney */}
                               {props.plants.species_name}
                           </Typography>
                       </Grid>
                       <Grid item className={classes.items}>
                           <Typography variant='subtitle1' className={classes.textStyles}>
                               {/* H2O Frequency: 2 days */}
                               H2O Frequency: {props.plants.frequency} {props.plants.interval_type_name}
                           </Typography>
                       </Grid>
                       <Grid item className={classes.items}>
                           <Typography variant='subtitle1' className={classes.textStyles}>
                               {/* Time: 8:00 am */}
                               Time: {props.plants.time}
                           </Typography>
                       </Grid>
